...
(function ( $, window, document, undefined ) {
	...
	Plugin.prototype = {
		...
		_createDirButtons: function () {
			...
			$('<button name="arriere" class="pogoSlider-dir-btn pogoSlider-dir-btn--prev"></button>').appendTo(self.$element).on('click', function () {
				self.prevSlide();
			});

			$('<button name="avant" class="pogoSlider-dir-btn pogoSlider-dir-btn--next"></button>').appendTo(self.$element).on('click', function () {
				self.nextSlide();
			});
